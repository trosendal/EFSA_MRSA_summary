## Annex Table 8: Methicillin-resistant Staphylococcus aureus spa-type
## characterization, 2024.
source("R/functions.R")
df_AMR <- read_AMR()
subdf <- df_AMR[df_AMR$repYear == 2024 & !is.na(df_AMR$T), ]
...
write.csv2(tab1_dt,
           file = "tables_and_figures/MRSA_AnnexE_tableE8.csv",
           row.names = FALSE)
