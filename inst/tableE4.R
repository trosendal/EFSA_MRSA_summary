## Annex E table 4: Methicillin-resistant Staphylococcus aureus in
## food-producing animals, clinical investigations excluded, 2023.
...
names(tab1) <- c("Animal", "Country", "Production type",
                 ...
                 "Positive for MRSA (%)")
write.csv2(tab1,
           file = "tables_and_figures/MRSA_AnnexE_tableE4_new.csv",
           row.names = FALSE)
